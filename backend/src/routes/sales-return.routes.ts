...
import { processReturnSchema } from '../validators/return.validators';
...
router.post('/', requirePermissions('returns:authorize'), validate(processReturnSchema), (req, res, next) => salesReturnController.processReturn(req, res, next));

...
// ── pdfmake font descriptor (uses built-in Roboto from the pdfmake package) ──
const fonts = {
  Roboto: {
    normal: require('pdfmake/build/vfs_fonts').pdfMake.vfs['Roboto-Regular.ttf']
      ? 'node_modules/pdfmake/build/vfs_fonts.js'
      : require.resolve('pdfmake/build/vfs_fonts'),
    bold: require.resolve('pdfmake/build/vfs_fonts'),
    italics: require.resolve('pdfmake/build/vfs_fonts'),
    bolditalics: require.resolve('pdfmake/build/vfs_fonts'),
  },
};
